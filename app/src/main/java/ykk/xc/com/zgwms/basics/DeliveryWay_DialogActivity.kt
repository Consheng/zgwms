...
import kotlinx.android.synthetic.main.ab_delivery_way_dialog.*
import okhttp3.*
import ykk.xc.com.zgwms.R
import ykk.xc.com.zgwms.basics.adapter.DeliveryWay_DialogAdapter
 ...
 * 选择部门dialog
 */
class DeliveryWay_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<DeliveryWay>()
    private var mAdapter: DeliveryWay_DialogAdapter? = null
    private val okHttpClient = OkHttpClient()
    private var limit = 1
    private var isRefresh: Boolean = false
    private var isLoadMore: Boolean = false
    private var isNextPage: Boolean = false
    private var parentNo :String? = null   // 上级代码

    // 消息处理
    private val mHandler = MyHandler(this)

    private class MyHandler(activity: DeliveryWay_DialogActivity) : Handler() {
        private val mActivity: WeakReference<DeliveryWay_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, DeliveryWay::class.java)
    ...
    override fun setLayoutResID(): Int {
        return R.layout.ab_delivery_way_dialog
    }
    ...
    override fun initView() {
        ...
        mAdapter = DeliveryWay_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("salOrder/findDeliveryWayList")
        val formBody = FormBody.Builder()
                .add("fnumberOrName", getValues(et_search).trim { it <= ' ' })
                .add("parentNo", isNULLS(parentNo))

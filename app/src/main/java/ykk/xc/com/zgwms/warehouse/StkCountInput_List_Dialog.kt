...
import kotlinx.android.synthetic.main.ware_count_input_list_dialog.*
import okhttp3.*
...
import ykk.xc.com.zgwms.warehouse.adapter.Stk_CountInput_List_DialogAdapter
 ...
 * 选择盘点单dialog
 */
class StkCountInput_List_Dialog : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<StkCountInput>()
    private var mAdapter: Stk_CountInput_List_DialogAdapter? = null
    ...
    private class MyHandler(activity: StkCountInput_List_Dialog) : Handler() {
        private val mActivity: WeakReference<StkCountInput_List_Dialog>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, StkCountInput::class.java)
    ...
    override fun setLayoutResID(): Int {
        return R.layout.ware_count_input_list_dialog
    }
    ...
    override fun initView() {
        ...
        mAdapter = Stk_CountInput_List_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("stkCountInput/findListByPage")

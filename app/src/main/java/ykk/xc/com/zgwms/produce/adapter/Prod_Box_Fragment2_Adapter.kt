...
class Prod_Box_Fragment2_Adapter(private val context: Activity, datas: List<MaterialBinningRecord>) : BaseArrayRecyclerAdapter<MaterialBinningRecord>(datas) {
    ...
    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: MaterialBinningRecord, pos: Int) {
        ...
        tv_prodNo.text = Html.fromHtml("发货单:&nbsp;<font color='#6a5acd'>"+ entity.fsourceNo +"</font>")

...
import ykk.xc.com.zgwms.warehouse.adapter.Other_OutStock_Fragment3_Adapter
 ...
 * 作者：ykk
 */
class Other_OutStock_Fragment3 : BaseFragment() {
    ...
    private var mAdapter: Other_OutStock_Fragment3_Adapter? = null
    ...
    private class MyHandler(activity: Other_OutStock_Fragment3) : Handler() {
        private val mActivity: WeakReference<Other_OutStock_Fragment3>
...
//                        }
    ...
    override fun initView() {
        ...
        mAdapter = Other_OutStock_Fragment3_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : Other_OutStock_Fragment3_Adapter.MyCallBack {

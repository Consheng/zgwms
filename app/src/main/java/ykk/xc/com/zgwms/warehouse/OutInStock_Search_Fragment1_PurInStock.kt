 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment1_PurInStock : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment1_PurInStock_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment1_PurInStock) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment1_PurInStock>
...
//                        }
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment1_PurInStock_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment1_PurInStock_Adapter.MyCallBack {

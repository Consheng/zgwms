 ...
 * 作者：ykk
 */
class Other_OutStock_MainActivity : BaseActivity() {

    private val REFRESH = 10

    private val context = this
    private val TAG = "Other_OutStock_MainActivity"
    private var curRadio: View? = null
    private var curRadioName: TextView? = null
    var isChange: Boolean = false // 返回的时候是否需要判断数据是否保存了

    val fragment1 = Other_OutStock_Fragment1()
    val fragment2 = Other_OutStock_Fragment2()
    val fragment3 = Other_OutStock_Fragment3()

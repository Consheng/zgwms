...
import ykk.xc.com.zgwms.warehouse.adapter.OutInStockSearchFragment2_QTRK_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment2_QTRK : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment2_QTRK_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment2_QTRK) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment2_QTRK>
...
//                        }
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment2_QTRK_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment2_QTRK_Adapter.MyCallBack {
            override fun onSearch(entity: ICStockBill, position: Int) {
                val bundle = Bundle()
                bundle.putInt("id", entity.id)
                show(Other_InStock_MainActivity::class.java, bundle)
            }

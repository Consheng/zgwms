...
class Sal_Sel_SalOutStock_DialogAdapter(private val context: Activity, private val datas: List<SalOutStock>) : BaseArrayRecyclerAdapter<SalOutStock>(datas) {
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.sal_sel_saloutstock_list_dialog_item
    }

    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: SalOutStock, pos: Int) {
        // 初始化id
...
//        tv_fnumber.text = entity.fbillNo
        tv_fnumber.text = Html.fromHtml(entity.fbillNo+"<br><font color='#6a5acd'>"+entity.cust.fname+"</font>")
    ...
    interface MyCallBack {
        fun onClick(entity: SalOutStock, position: Int)
    }

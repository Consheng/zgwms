...
import ykk.xc.com.zgwms.warehouse.adapter.OutInStockSearchFragment3_QTCK_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment3_QTCK : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment3_QTCK_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment3_QTCK) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment3_QTCK>
...
//                        }
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment3_QTCK_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment3_QTCK_Adapter.MyCallBack {
            override fun onSearch(entity: ICStockBill, position: Int) {
                val bundle = Bundle()
                bundle.putInt("id", entity.id)
                show(Other_OutStock_MainActivity::class.java, bundle)
            }

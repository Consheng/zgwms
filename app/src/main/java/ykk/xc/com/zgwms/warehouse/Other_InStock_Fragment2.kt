 ...
 * 作者：ykk
 */
class Other_InStock_Fragment2 : BaseFragment() {
    ...
    private class MyHandler(activity: Other_InStock_Fragment2) : Handler() {
        private val mActivity: WeakReference<Other_InStock_Fragment2>
...
//                                }
    ...
    fun showLocalStockGroup(key :String) {
        ...
        // 显示调入仓库---------------------
        if(spfStock.contains(key+"_BIND_OTHER_IN_STOCK")) {
            stock = showObjectByXml(Stock_K3::class.java, key+"_BIND_OTHER_IN_STOCK", saveDefaultStock)

...
import ykk.xc.com.zgwms.sales.adapter.Sal_OutStock_Fragment3_Adapter
 ...
 * 作者：ykk
 */
class Sal_OutStock_Fragment3 : BaseFragment() {
    ...
    private var mAdapter: Sal_OutStock_Fragment3_Adapter? = null
    ...
    private class MyHandler(activity: Sal_OutStock_Fragment3) : Handler() {
        private val mActivity: WeakReference<Sal_OutStock_Fragment3>
    ...
    override fun initView() {
        ...
        mAdapter = Sal_OutStock_Fragment3_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : Sal_OutStock_Fragment3_Adapter.MyCallBack {

...
import ykk.xc.com.zgwms.basics.adapter.Mtl_DialogAdapter
...
class Mtl_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {
    ...
    private var fiscoby :String? = null // 可为联副产品
    ...
    override fun initData() {
        ...
        if (bundle != null) {
            ...
            fiscoby = bundle.getString("fiscoby", "")
        }
    ...
    private fun run_okhttpDatas() {
        ...
        val formBody = FormBody.Builder()
                ...
                .add("fiscoby", fiscoby) // 可为联副产品（生产入库用到）
        ...
        call.enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                Log.e("Mtl_DialogActivity --> onResponse", result)

...
class Pur_Sel_PurReceive_DialogAdapter(private val context: Activity, private val datas: List<PurReceive>) : BaseArrayRecyclerAdapter<PurReceive>(datas) {
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.pur_sel_receive_list_dialog_item
    }

    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: PurReceive, pos: Int) {
        // 初始化id
...
//        tv_fnumber.text = entity.fbillNo
    ...
    interface MyCallBack {
        fun onClick(entity: PurReceive, position: Int)
    }

...
import ykk.xc.com.zgwms.basics.adapter.AssistantData_CarVersion_DialogAdapter
import ykk.xc.com.zgwms.bean.k3Bean.AssistantData_CarVersion
 ...
 * 选择车型版号dialog
 */
class AssistantData_CarVersion_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<AssistantData_CarVersion>()
    private var mAdapter: AssistantData_CarVersion_DialogAdapter? = null
    ...
    private class MyHandler(activity: AssistantData_CarVersion_DialogActivity) : Handler() {
        private val mActivity: WeakReference<AssistantData_CarVersion_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, AssistantData_CarVersion::class.java)
    ...
    override fun initView() {
        ...
        mAdapter = AssistantData_CarVersion_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("assistantData/findCarVersionByPage")

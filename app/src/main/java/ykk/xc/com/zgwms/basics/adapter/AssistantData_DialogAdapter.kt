...
class AssistantData_DialogAdapter(private val context: Activity, private val datas: List<AssistantData>) : BaseArrayRecyclerAdapter<AssistantData>(datas) {
    ...
    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: AssistantData, pos: Int) {
        // 初始化id
    ...
    interface MyCallBack {
        fun onClick(entity: AssistantData, position: Int)
    }

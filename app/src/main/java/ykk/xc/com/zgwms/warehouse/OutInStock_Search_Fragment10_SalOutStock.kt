...
import ykk.xc.com.zgwms.purchase.Pur_InStock_MainActivity
import ykk.xc.com.zgwms.sales.Sal_OutStock_MainActivity
...
import ykk.xc.com.zgwms.warehouse.adapter.OutInStockSearchFragment10_SalOutStock_Adapter
import ykk.xc.com.zgwms.warehouse.adapter.OutInStockSearchFragment1_PurInStock_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment10_SalOutStock : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment10_SalOutStock_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment10_SalOutStock) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment10_SalOutStock>
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment10_SalOutStock_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment10_SalOutStock_Adapter.MyCallBack {
            override fun onSearch(entity: ICStockBill, position: Int) {
                val bundle = Bundle()
                bundle.putInt("id", entity.id)
                show(Sal_OutStock_MainActivity::class.java, bundle)
            }

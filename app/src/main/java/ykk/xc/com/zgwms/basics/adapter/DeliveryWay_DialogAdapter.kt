...
class DeliveryWay_DialogAdapter(private val context: Activity, private val datas: List<DeliveryWay>) : BaseArrayRecyclerAdapter<DeliveryWay>(datas) {
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.ab_delivery_way_dialog_item
    }

    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: DeliveryWay, pos: Int) {
        // 初始化id
    ...
    interface MyCallBack {
        fun onClick(entity: DeliveryWay, position: Int)
    }

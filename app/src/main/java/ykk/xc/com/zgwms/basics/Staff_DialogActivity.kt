...
import ykk.xc.com.zgwms.basics.adapter.Staff_DialogAdapter
 ...
 * 选择员工dialog
 */
class Staff_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<Staff_K3>()
    private var mAdapter: Staff_DialogAdapter? = null
    ...
    private class MyHandler(activity: Staff_DialogActivity) : Handler() {
        private val mActivity: WeakReference<Staff_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, Staff_K3::class.java)
    ...
    override fun initView() {
        ...
        mAdapter = Staff_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("staff/findListByPage")

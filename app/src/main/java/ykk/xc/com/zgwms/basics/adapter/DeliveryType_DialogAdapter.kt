...
class DeliveryType_DialogAdapter(private val context: Activity, private val datas: List<DeliveryType>) : BaseArrayRecyclerAdapter<DeliveryType>(datas) {
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.ab_delivery_type_dialog_item
    }

    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: DeliveryType, pos: Int) {
        // 初始化id
    ...
    interface MyCallBack {
        fun onClick(entity: DeliveryType, position: Int)
    }

...
import ykk.xc.com.zgwms.basics.adapter.Organization_DialogAdapter
 ...
 * 选择组织dialog
 */
class Organization_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<Organization_K3>()
    private var mAdapter: Organization_DialogAdapter? = null
    ...
    private class MyHandler(activity: Organization_DialogActivity) : Handler() {
        private val mActivity: WeakReference<Organization_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, Organization_K3::class.java)
    ...
    override fun initView() {
        ...
        mAdapter = Organization_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("organization/findListByPage")

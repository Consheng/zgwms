...
import kotlinx.android.synthetic.main.ab_delivery_type_dialog.*
import okhttp3.*
import ykk.xc.com.zgwms.R
import ykk.xc.com.zgwms.basics.adapter.DeliveryType_DialogAdapter
 ...
 * 选择部门dialog
 */
class DeliveryType_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<DeliveryType>()
    private var mAdapter: DeliveryType_DialogAdapter? = null
    ...
    private class MyHandler(activity: DeliveryType_DialogActivity) : Handler() {
        private val mActivity: WeakReference<DeliveryType_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, DeliveryType::class.java)
    ...
    override fun setLayoutResID(): Int {
        return R.layout.ab_delivery_type_dialog
    }
    ...
    override fun initView() {
        ...
        mAdapter = DeliveryType_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("salOrder/findDeliveryTypeList")

...
import ykk.xc.com.zgwms.basics.adapter.StockPos_DialogAdapter
...
class StockPos_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {
    ...
    private val listDatas = ArrayList<StockPosition_K3>()
    ...
    private var fstockId: Int = 0 // 仓库id
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, StockPosition_K3::class.java)
    ...
    private fun run_okhttpDatas() {
        ...
        val formBody = FormBody.Builder()
                ...
                .add("fstockId", fstockId.toString())

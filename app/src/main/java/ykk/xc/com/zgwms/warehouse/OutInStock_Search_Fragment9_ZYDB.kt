...
import ykk.xc.com.zgwms.warehouse.adapter.OutInStockSearchFragment4_ZJDBD_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment9_ZYDB : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment4_ZJDBD_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment9_ZYDB) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment9_ZYDB>
...
//                        }
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment4_ZJDBD_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment4_ZJDBD_Adapter.MyCallBack {
            override fun onSearch(entity: ICStockBill, position: Int) {
                val bundle = Bundle()
                bundle.putInt("id", entity.id)
                show(Ware_ZY_Transfer_MainActivity::class.java, bundle)
            }

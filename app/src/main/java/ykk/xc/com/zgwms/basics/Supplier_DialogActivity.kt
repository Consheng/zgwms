...
import ykk.xc.com.zgwms.basics.adapter.Supplier_DialogAdapter
...
class Supplier_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {
    ...
    private val listDatas = ArrayList<Supplier_K3>()
    ...
    private var checkDatas: List<Supplier_K3>? = null // 上个界面传过来的供应商列表
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
                        val list = JsonUtil.strToList2(msg.obj as String, Supplier_K3::class.java)

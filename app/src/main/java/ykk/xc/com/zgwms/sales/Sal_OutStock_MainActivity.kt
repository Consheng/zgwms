 ...
 * 作者：ykk
 */
class Sal_OutStock_MainActivity : BaseActivity() {

    private val REFRESH = 10

    private val context = this
    private val TAG = "Sal_OutStock_MainActivity"
    private var curRadio: View? = null
    private var curRadioName: TextView? = null
    var isChange: Boolean = false // 返回的时候是否需要判断数据是否保存了

    val fragment1 = Sal_OutStock_Fragment1()
    val fragment2 = Sal_OutStock_Fragment2()
    val fragment3 = Sal_OutStock_Fragment3()

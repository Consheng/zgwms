...
import kotlinx.android.synthetic.main.sal_out_stock_red_fragment2.*
import okhttp3.*
...
//                                }
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.sal_out_stock_red_fragment2, container, false)
    }
    ...
    fun showLocalStockGroup(key :String) {
        ...
        // 显示调入仓库---------------------
        if(spfStock.contains(key+"_BIND_SAL_OUT_STOCK_RED")) {
            stock = showObjectByXml(Stock_K3::class.java, key+"_BIND_SAL_OUT_STOCK_RED", saveDefaultStock)

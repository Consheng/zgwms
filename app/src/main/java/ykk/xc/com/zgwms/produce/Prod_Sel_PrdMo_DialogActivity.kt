...
import kotlinx.android.synthetic.main.prod_sel_prdmo_list_dialog.*
import okhttp3.*
import ykk.xc.com.zgwms.R
import ykk.xc.com.zgwms.bean.prod.PrdMo
import ykk.xc.com.zgwms.comm.BaseDialogActivity
import ykk.xc.com.zgwms.produce.adapter.Prod_Sel_PrdMo_DialogAdapter
 ...
 * 选择生产订单单号dialog
 */
class Prod_Sel_PrdMo_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {

    private val context = this
    private val listDatas = ArrayList<PrdMo>()
    private var mAdapter: Prod_Sel_PrdMo_DialogAdapter? = null
    ...
    private class MyHandler(activity: Prod_Sel_PrdMo_DialogActivity) : Handler() {
        private val mActivity: WeakReference<Prod_Sel_PrdMo_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 // 成功
                    -> {
//                        val list = JsonUtil.strToList2(msg.obj as String, PrdMo::class.java)
                        val list = JsonUtil.strToList(msg.obj as String, PrdMo::class.java)
...
//                        m.xRecyclerView.isLoadingMoreEnabled = m.isNextPage
    ...
    override fun setLayoutResID(): Int {
        return R.layout.prod_sel_prdmo_list_dialog
    }
    ...
    override fun initView() {
        ...
        mAdapter = Prod_Sel_PrdMo_DialogAdapter(context, listDatas)
    ...
    private fun run_okhttpDatas() {
        ...
        val mUrl = getURL("prdMo/findPortionByParam_Parent")
        val formBody = FormBody.Builder()
                .add("fuseOrgId", fuseOrgId.toString())
                .add("execStatus", "4") // 已经开工的才查询

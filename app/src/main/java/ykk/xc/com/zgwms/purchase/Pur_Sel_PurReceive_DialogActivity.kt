...
import kotlinx.android.synthetic.main.pur_sel_receive_list_dialog.*
import okhttp3.*
...
import ykk.xc.com.zgwms.purchase.adapter.Pur_Sel_PurReceive_DialogAdapter
 ...
 * 选择收料通知单单号dialog
 */
class Pur_Sel_PurReceive_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {
    ...
    private val listDatas = ArrayList<PurReceive>()
    private var mAdapter: Pur_Sel_PurReceive_DialogAdapter? = null
    ...
    private class MyHandler(activity: Pur_Sel_PurReceive_DialogActivity) : Handler() {
        private val mActivity: WeakReference<Pur_Sel_PurReceive_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    ...
                    SUCC2 -> {// 查询列表   成功
                        val list = JsonUtil.strToList(msgObj, PurReceive::class.java)
...
//                        m.xRecyclerView.isLoadingMoreEnabled = m.isNextPage
    ...
    override fun setLayoutResID(): Int {
        return R.layout.pur_sel_receive_list_dialog
    }
    ...
    override fun initView() {
        ...
        mAdapter = Pur_Sel_PurReceive_DialogAdapter(context, listDatas)
    ...
    private fun run_smDatas() {
        ...
        var mUrl = getURL("purReceive/findBarcodeGetFid")
    ...
    private fun run_okhttpDatas() {
        showLoadDialog("加载中...", false)
        val mUrl = getURL("purReceive/findPortionByParam_Parent")
        val formBody = FormBody.Builder()
...
//                .add("strFid", isNULLS(strFid))
                .add("strSourceId", isNULLS(strFid))

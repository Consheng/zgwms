...
class Organization_DialogAdapter(private val context: Activity, private val datas: List<Organization_K3>) : BaseArrayRecyclerAdapter<Organization_K3>(datas) {
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.ab_org_dialog_item
    }

    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: Organization_K3, pos: Int) {
        // 初始化id
    ...
    interface MyCallBack {
        fun onClick(entity: Organization_K3, position: Int)
    }

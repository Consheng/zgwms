...
class Sal_Sel_Delivery_DialogAdapter(private val context: Activity, private val datas: List<DeliveryNotice>) : BaseArrayRecyclerAdapter<DeliveryNotice>(datas) {
    private var callBack: MyCallBack? = null

    override fun bindView(viewtype: Int): Int {
        return R.layout.sal_sel_delivery_list_dialog_item
    }

    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: DeliveryNotice, pos: Int) {
        // 初始化id
...
//        tv_fnumber.text = entity.fbillNo
        tv_fnumber.text = Html.fromHtml(entity.fbillNo+"<br><font color='#6a5acd'>"+entity.deliCust.fname+"</font>")
    ...
    interface MyCallBack {
        fun onClick(entity: DeliveryNotice, position: Int)
    }

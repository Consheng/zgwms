...
import okhttp3.*
import ykk.xc.com.zgwms.bean.SystemSet
...
import ykk.xc.com.zgwms.comm.MyApplication.getContext
import ykk.xc.com.zgwms.entrance.MainTabFragmentActivity
import ykk.xc.com.zgwms.entrance.Main_Supplier_Activity
import ykk.xc.com.zgwms.entrance.page5.ServiceSetActivity
    ...
    private class MyHandler(activity: LoginKt) : Handler() {
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    SUCC1 -> {// 登录成功
                        val user = JsonUtil.strToObject(msgObj, User::class.java)

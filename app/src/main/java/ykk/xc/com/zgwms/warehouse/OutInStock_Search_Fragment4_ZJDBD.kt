 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment4_ZJDBD : BaseFragment() {
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment4_ZJDBD) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment4_ZJDBD>
...
//        run_findList()
    ...
    private fun run_findList() {
        ...
        val formBody = FormBody.Builder()
                ...
                .add("strBillType", "ZJDBD") // 根据不同类型查询

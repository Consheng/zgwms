...
class OutInStockSearchFragment7_CGTL_Adapter(private val context: Activity, datas: List<ICStockBill>) : BaseArrayRecyclerAdapter<ICStockBill>(datas) {
    ...
    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: ICStockBill, pos: Int) {
        ...
        if(entity.stockOrg != null) {
            tv_recOrgName.text = Html.fromHtml("退料组织:&nbsp;<font color='#6a5acd'>"+ entity.stockOrg.fname +"</font>")
        } else {
            tv_recOrgName.text = "退料组织:"
        }

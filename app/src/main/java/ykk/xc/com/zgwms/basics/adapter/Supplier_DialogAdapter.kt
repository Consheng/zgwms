...
class Supplier_DialogAdapter(private val context: Activity, private val datas: List<Supplier_K3>) : BaseArrayRecyclerAdapter<Supplier_K3>(datas) {
    ...
    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: Supplier_K3, pos: Int) {
        // 初始化id
    ...
    interface MyCallBack {
        fun onClick(entity: Supplier_K3, position: Int)
    }

...
class OutInStockSearchFragment1_PurInStock_Adapter(private val context: Activity, datas: List<ICStockBill>) : BaseArrayRecyclerAdapter<ICStockBill>(datas) {
    ...
    override fun onBindHoder(holder: BaseRecyclerAdapter.RecyclerHolder, entity: ICStockBill, pos: Int) {
        ...
        if(entity.stockOrg != null) {
            tv_recOrgName.text = Html.fromHtml("收料组织:&nbsp;<font color='#6a5acd'>"+ entity.stockOrg.fname +"</font>")
        } else {
            tv_recOrgName.text = "收料组织:"
        }
        if(entity.stockOutOrg != null) {
            tv_purOrgName.text = Html.fromHtml("采购组织:&nbsp;<font color='#6a5acd'>"+ entity.stockOutOrg.fname +"</font>")
        } else {
            tv_purOrgName.text = "采购组织:"
        }
        ...
        tv_empName.text = Html.fromHtml("采购员:&nbsp;<font color='#000000'>"+ entity.empName +"</font>")

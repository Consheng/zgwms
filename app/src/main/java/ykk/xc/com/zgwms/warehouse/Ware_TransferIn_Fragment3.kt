...
import kotlinx.android.synthetic.main.ware_transfer_in_fragment3.*
...
import ykk.xc.com.zgwms.warehouse.adapter.Ware_TransferIn_Fragment3_Adapter
 ...
 * 作者：ykk
 */
class Ware_TransferIn_Fragment3 : BaseFragment() {
    ...
    private var mAdapter: Ware_TransferIn_Fragment3_Adapter? = null
    ...
    private class MyHandler(activity: Ware_TransferIn_Fragment3) : Handler() {
        private val mActivity: WeakReference<Ware_TransferIn_Fragment3>
...
//                        }
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.ware_transfer_in_fragment3, container, false)
    }
    ...
    override fun initView() {
        ...
        mAdapter = Ware_TransferIn_Fragment3_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : Ware_TransferIn_Fragment3_Adapter.MyCallBack {

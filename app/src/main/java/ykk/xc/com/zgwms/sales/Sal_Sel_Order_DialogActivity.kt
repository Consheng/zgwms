...
import kotlinx.android.synthetic.main.sal_sel_order_list_dialog.*
import okhttp3.*
...
import ykk.xc.com.zgwms.sales.adapter.Sal_Sel_Order_DialogAdapter
 ...
 * 选择销售订单单号dialog
 */
class Sal_Sel_Order_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {
    ...
    private val listDatas = ArrayList<SalOrder>()
    private var mAdapter: Sal_Sel_Order_DialogAdapter? = null
    private val okHttpClient = OkHttpClient()
    private var limit = 1
    private var isRefresh = false
    private var isLoadMore = false
    private var isNextPage = false
    private var fstockOrgId = 0   // 库存组织
    private var fsaleOrgId = 0   // 销售组织
    ...
    private class MyHandler(activity: Sal_Sel_Order_DialogActivity) : Handler() {
        private val mActivity: WeakReference<Sal_Sel_Order_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    ...
                    SUCC2 -> { // 查询列表   成功
                        val list = JsonUtil.strToList(msgObj, SalOrder::class.java)
...
//                        m.xRecyclerView.isLoadingMoreEnabled = m.isNextPage
    ...
    override fun setLayoutResID(): Int {
        return R.layout.sal_sel_order_list_dialog
    }
    ...
    override fun initView() {
        ...
        mAdapter = Sal_Sel_Order_DialogAdapter(context, listDatas)
    ...
    private fun run_smDatas() {
        ...
        var mUrl = getURL("salOrder/findBarcodeGetFid")
    ...
    private fun run_okhttpDatas() {
        showLoadDialog("加载中...", false)
        val mUrl = getURL("salOrder/findPortionByParam_Parent")
        val formBody = FormBody.Builder()

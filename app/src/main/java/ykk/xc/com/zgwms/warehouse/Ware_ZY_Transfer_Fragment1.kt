...
import kotlinx.android.synthetic.main.ware_zy_transfer_fragment1.*
import okhttp3.*
 ...
 * 作者：ykk
 */
class Ware_ZY_Transfer_Fragment1 : BaseFragment() {
...
//    var isReset = false // 是否点击了重置按钮.
    ...
    private class MyHandler(activity: Ware_ZY_Transfer_Fragment1) : Handler() {
        private val mActivity: WeakReference<Ware_ZY_Transfer_Fragment1>
...
//                        m.run_purReceiveList()
    ...
    override fun setLayoutResID(inflater: LayoutInflater, container: ViewGroup): View {
        return inflater.inflate(R.layout.ware_zy_transfer_fragment1, container, false)
    }
...
//        hideSoftInputMode(mContext, et_code)
        ...
        icstockBill.billType = "ZYDB" // 自由调拨单（K3直接调拨单）
        icstockBill.ftranType = 44

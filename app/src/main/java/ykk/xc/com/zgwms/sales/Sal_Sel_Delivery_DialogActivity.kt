...
import kotlinx.android.synthetic.main.sal_sel_delivery_list_dialog.*
import okhttp3.*
import ykk.xc.com.zgwms.R
import ykk.xc.com.zgwms.bean.sales.DeliveryNotice
...
import ykk.xc.com.zgwms.sales.adapter.Sal_Sel_Delivery_DialogAdapter
 ...
 * 选择发货通知单单号dialog
 */
class Sal_Sel_Delivery_DialogActivity : BaseDialogActivity(), XRecyclerView.LoadingListener {
    ...
    private val listDatas = ArrayList<DeliveryNotice>()
    private var mAdapter: Sal_Sel_Delivery_DialogAdapter? = null
    private val okHttpClient = OkHttpClient()
    private var limit = 1
    private var isRefresh = false
    private var isLoadMore = false
    private var isNextPage = false
    private var fdeliveryOrgId = 0   // 收料组织
    private var fsaleOrgId = 0   // 采购组织
    private var fcustId = 0 // 客户id
    private var fsrcType :String? = null // 源单类型
    ...
    private class MyHandler(activity: Sal_Sel_Delivery_DialogActivity) : Handler() {
        private val mActivity: WeakReference<Sal_Sel_Delivery_DialogActivity>
        ...
        override fun handleMessage(msg: Message) {
            ...
            if (m != null) {
                ...
                when (msg.what) {
                    ...
                    SUCC2 -> {// 查询列表   成功
                        val list = JsonUtil.strToList(msgObj, DeliveryNotice::class.java)
...
//                        m.xRecyclerView.isLoadingMoreEnabled = m.isNextPage
    ...
    override fun setLayoutResID(): Int {
        return R.layout.sal_sel_delivery_list_dialog
    }
    ...
    override fun initView() {
        ...
        mAdapter = Sal_Sel_Delivery_DialogAdapter(context, listDatas)
    ...
    override fun initData() {
        ...
        if (bundle != null) {
            fdeliveryOrgId = bundle.getInt("fdeliveryOrgId")
            fsaleOrgId = bundle.getInt("fsaleOrgId")
            fcustId = bundle.getInt("fcustId")
            fsrcType = bundle.getString("fsrcType","")
        }
    ...
    private fun run_smDatas() {
        ...
        var mUrl = getURL("deliveryNotice/findBarcodeGetFid")
    ...
    private fun run_okhttpDatas() {
        showLoadDialog("加载中...", false)
        val mUrl = getURL("deliveryNotice/findPortionByParam_Parent")
        val formBody = FormBody.Builder()
                .add("fdeliveryOrgId", fdeliveryOrgId.toString())
                .add("fsaleOrgId", fsaleOrgId.toString())
                .add("fcustId", fcustId.toString())
                .add("fsrcType", isNULLS(fsrcType))

...
import ykk.xc.com.zgwms.produce.Prod_InStock_MainActivity
...
import ykk.xc.com.zgwms.warehouse.adapter.OutInStockSearchFragment8_SCRK_Adapter
 ...
 * 作者：ykk
 */
class OutInStock_Search_Fragment8_SCRK : BaseFragment() {
    ...
    private var mAdapter: OutInStockSearchFragment8_SCRK_Adapter? = null
    ...
    private class MyHandler(activity: OutInStock_Search_Fragment8_SCRK) : Handler() {
        private val mActivity: WeakReference<OutInStock_Search_Fragment8_SCRK>
...
//                        }
    ...
    override fun initView() {
        ...
        mAdapter = OutInStockSearchFragment8_SCRK_Adapter(mContext!!, checkDatas)
        recyclerView.adapter = mAdapter
        // 设值listview空间失去焦点
        recyclerView.isFocusable = false

        // 行事件
        mAdapter!!.setCallBack(object : OutInStockSearchFragment8_SCRK_Adapter.MyCallBack {

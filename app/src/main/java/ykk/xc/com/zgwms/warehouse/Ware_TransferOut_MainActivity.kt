...
import kotlinx.android.synthetic.main.ware_transfer_out_main.*
 ...
 * 作者：ykk
 */
class Ware_TransferOut_MainActivity : BaseActivity() {

    private val REFRESH = 10

    private val context = this
    private val TAG = "Ware_TransferOut_MainActivity"
    private var curRadio: View? = null
    private var curRadioName: TextView? = null
    var isChange: Boolean = false // 返回的时候是否需要判断数据是否保存了

    val fragment1 = Ware_TransferOut_Fragment1()
    val fragment2 = Ware_TransferOut_Fragment2()
    val fragment3 = Ware_TransferOut_Fragment3()
    var isMainSave = false // 主表信息是否保存
    var pageId = 0

    override fun setLayoutResID(): Int {
        return R.layout.ware_transfer_out_main
    }
